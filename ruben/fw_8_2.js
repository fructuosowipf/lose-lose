  ...
  */
  ...
  switch (zufall) {
    ...
    case 1:
      ...
      image(another, random(0, windowWidth), random(0, windowHeight), random(2000, 5000), random(1500, 3800));
    ...
    case 2:
      ...
      square(random(0, windowWidth), random(0, windowHeight), random(500, 1500), 3000, 2500);
    ...
    case 3:
      ...
      noStroke(); /* Damit Objekt keine Rahmenlinie erhält, anonsten einfach auskommentieren oder entfernen und mit stroke() Rahmen definieren */
      rect(random(0, windowWidth), random(0, windowHeight), random(800, 3000), random(1000, 5200)); /* Erzeugt Viereck, Werte: (X-Koordinate, Y-Koordinate, Breite, Höhe) */
      break;
    ...
    case 6:
      //Objekt Bild erzeugen:
      rotate(random(5, 300)); /* Rotation des Bildes, Angabe des Rotationswinkels in der Klammer */
      image(another, random(0, windowWidth), random(0, windowHeight), random(1300, 6800), random(800, 4000));
